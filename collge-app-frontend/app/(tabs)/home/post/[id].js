...
import ReelsTemplate from '../../../../components/Reels/ReelsTemplate'
...
const MentionedPost = () =>
{
    ...
    {
        return (
            <DynamicReelTemplate likeStatus={postData.likeStatus} handleShowCommentsModal={openCommentsModal} votes={postData.votes} name={postData.firstName} username={postData.username} userId={postData.userId} avatar={postData.avatar} vidSource={postData.source[0]} role={postData.role} isPremiumUser={postData.isPremiumUser} caption={postData.caption} focused={true} postId={postData.postId}></DynamicReelTemplate>
        )
    }
