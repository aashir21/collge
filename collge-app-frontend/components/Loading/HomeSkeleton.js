...
const HomeSkeleton = () =>
{
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ paddingTop: SIZES.xxLarge, justifyContent: "flex-start", alignItems: "flex-start", marginVertical: SIZES.large, flexDirection: "row", width: width - 32 }}>
                <SkeletonContainer isLoading={true} Gradient={Gradient} colors={["#30353d", "#505761", "#3b3f45"]} style={[styles.storyCon, { backgroundColor: COLORS.skeletonBG }]}>
                    <View>
                        <Image style={{ objectFit: "cover", height: 78, width: 78, borderRadius: 78 / 2 }} />
                    ...
                    <Image style={{ objectFit: "cover", height: 78, width: 78, borderRadius: 78 / 2, marginHorizontal: SIZES.xSmall, }} />
                    <Image style={{ objectFit: "cover", height: 78, width: 78, borderRadius: 78 / 2 }} />
                    <Image style={{ objectFit: "cover", height: 78, width: 78, borderRadius: 78 / 2, marginHorizontal: SIZES.xSmall, }} />
                    <Image style={{ objectFit: "cover", height: 78, width: 78, borderRadius: 78 / 2 }} />
                </SkeletonContainer>
...
const styles = StyleSheet.create({
    container: {
        ...
        paddingTop: StatusBar.currentHeight + 96,
    }
    ,
    storiesContainer: {
        flex: 0.3,
