...
const DeleteAccountModal = ({ isVisible, onClose }) =>
{
    ...
    const deleteUser = async () =>
    {
        ...
        try
        {
            ...
            const response = await customFetch(`${ENDPOINT.BASE_URL}/api/v1/user/deleteAccount/${currentUserId}`, {
                method: "DELETE"
            })
            ...
            <Pressable style={styles.overlay} onPress={handleOverlayPress}>
                {
                    isLoading ?
                        ...
                        >
                            ...
                            <Text style={styles.subTitle}>Deleting your account will delete your personal information such as name, email and any personal data collected by Collge. Once deleted, this account cannot be reinstated.</Text>
                            <TouchableOpacity onPress={deleteUser} disabled={isDisabled} style={[styles.actionBtn, { opacity: isDisabled ? 0.2 : 1 }]}>
                                <Text style={styles.btnTitle}>Yes, delete my account</Text>
                            </TouchableOpacity>
                        </Animated.View>
                }
            </Pressable >
