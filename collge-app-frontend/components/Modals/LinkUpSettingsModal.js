...
import { COLORS, ENDPOINT, REPORT_REQUEST_TYPES, SIZES } from '../../constants/theme';
...
const LinkUpSettingsModal = ({ userId, isVisible, onClose, postId, sourceScreen, deletePost, editing }) =>
{
    ...
    const handleDelete = async () =>
    {
        try
        {
            const response = customFetch(`${ENDPOINT.BASE_URL}/api/v1/linkup?postId=${postId}`, {
                method: 'DELETE',
                headers: {
        ...
        <Modal transparent visible={active} onRequestClose={onClose} >
            <Pressable style={styles.overlay} onPress={handleOverlayPress}>
                ...
                >
                    ...
                    {
                        storageUserId == userId ? null : <ProfileTab onClose={onClose} userId={userId} />
                    }
                    ...
                    {
                        storageUserId == userId ? null : <ReportTab postId={postId} userId={userId} onClose={onClose} type={REPORT_REQUEST_TYPES.LINKUP} />
                    }
...
export default LinkUpSettingsModal;
