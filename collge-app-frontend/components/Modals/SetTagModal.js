...
import { Animated, Keyboard, Modal, Image, StyleSheet, TextInput, TouchableOpacity, View, Text, Easing, ActivityIndicator, useWindowDimensions, FlatList, Platform, PanResponder, Dimensions } from 'react-native';
...
const SetTagModal = ({ isVisible, onClose, handleTaggedUsers, listOfTaggedUsers }) =>
{
                                    ...
                                    <View style={{ flex: 1, marginVertical: SIZES.medium }}>
                                        {
                                            results.length > 0 ? <FlatList
                                                ...
                                                renderItem={({ item }) => <SearchResult
                                                    ...
                                                    cardOnPress={handleTaggedUsers}
                                                    listOfTaggedUsers={listOfTaggedUsers}
                                                />
                                                }
