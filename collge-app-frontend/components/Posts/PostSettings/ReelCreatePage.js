...
const ReelCreatePage = () =>
{
    ...
    const handleTextChange = (text) =>
    {
        ...
        if (trimmedText && selectedImages.length === 1)
        {
    ...
    const checkMediaSize = async () =>
    {
        ...
        else
        {
            ...
            toast.show("Tapes must be 20MB or less and no longer than 30 seconds.", {
                placement: "top",
                duration: 5000
            })
        }
                    ...
                    !openMentionModal ? <View>
                        ...
                        <View style={[styles.captionContainer, { width: width - 32 }]}>
                            ...
                            <View style={styles.btnContainer}>
                                ...
                                <MediaBtn widthSize={"45%"} types={["videos"]} title={"Media"} bgColor={COLORS.primary} isDisabled={isMediaBtnDisabled} onImagesSelected={handleImagesSelected} handleDisablePostBtnState={handleDisablePostBtnState} handleLoadingState={handleLoadingState} mediaLimit={1} />
