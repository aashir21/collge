...
import com.collge.POSTSERVICE.dto.LinkUpMediaDTO;
...
public class AWSService {
    ...
    public PostData convertToPostData(PostDTO PostDTO, List<String> filePaths, String postType) {

        PostData newPost = PostData.builder()
                .userId(PostDTO.getUserId())
                .universityId(PostDTO.getUniversityId())
                .createdAt(LocalDateTime.now())
                .votes(0)
                .caption(PostDTO.getCaption())
                .filePath(filePaths)
                .postType(postType)
                .mediaThumbnail(PostDTO.getMediaThumbnailUrl())
                .isEdited(false)
                .isGlobal(PostDTO.getIsGlobal())
                .build();

        return newPost;
    }

    public LinkUpMedia convertToLinkUpMedia(LinkUpMediaDTO linkupMedia, List<String> mediaUrls){

        LinkUpMedia mediaDTO = LinkUpMedia.builder()
                .userId(linkupMedia.getUserId())
                .mediaUrl(linkupMedia.getMediaUrl())
                .build();
